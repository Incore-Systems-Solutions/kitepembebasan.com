...
class ArtikelController extends Controller
{
    ...
    public function detailArtikel($slug)
    {
        ...
        $stopwords = [
            ...
            'sudah', 'belum', 'tidak', 'bisa', 'harus', 'lebih', 'kurang', 'namun', 'meskipun', 'secara', 'dapat', 'memungkinkan', 'menjadi', 'bahwa', 'mereka', 'penting', 'tetap', 'lanjut', 'terhadap', 'tepat', 'seperti', 'keseluruhan', 'meningkatkan', 'banyak', 'semakin', 'bagaimana', 'mengelola', 'berbagai', 'berlaku', 'solusi', 'anggota', 'dirancang', 'fitur', 'jarak', 'membantu', 'antara', 'terstruktur', 'setiap', 'melacak', 'memiliki', 'mengurangi', 'pasar', 'proses', 'sangat', 'memahami', 'pelaku', 'menguntungkan', 'pelaku', 'biaya', 'keterangan', 'hingga', 'pengurangan', 'kemudian', 'indonesia', 'kendala', 'jangkauan', 'manfaat', 'didapat', 'barangmanfaat', 'mengalami', 'mulai', 'memperluas', 'dibutuhkan', 'masuk', 'beberapa', 'signifikan', 'khusus', 'diperlukan', 'serta', 'telah', 'terkait'
        ];

        $industryTerms = [
            'KITE pembebasan', 'kemudahan impor tujuan ekspor', 'fasilitas kepabeanan', 'izin KITE',
            'pengajuan KITE', 'pengawasan bea cukai', 'perizinan ekspor impor', 'pengeluaran barang',
            'barang impor', 'barang ekspor', 'sistem kepabeanan', 'laporan ekspor',
            'dokumen pabean', 'penangguhan bea masuk', 'logistik industri ekspor', 'pendampingan KITE',
            'pengusaha kawasan berikat', 'implementasi sistem pelaporan', 'audit kepabeanan'
        ];
