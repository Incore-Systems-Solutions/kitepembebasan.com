...
@section('meta')
   ...
   <!-- Meta Item -->
    ...
    <title>{{ $meta['meta'][$lang]['title'] ?? 'Hubungi Kami – Kitepembebasan.com' }}</title>
    <meta name="description" content="{{ $meta['meta'][$lang]['description'] ?? 'Hubungi tim kami untuk informasi seputar KITE Pembebasan, proses pengajuan, dan pendampingan teknis kepabeanan. Kami siap membantu pelaku industri ekspor.' }}">
    <meta name="keywords" content="{{ $meta['meta'][$lang]['keywords'] ?? 'kontak KITE, program KITE Pembebasan, konsultasi ekspor, kemudahan impor, bea cukai, izin KITE, industri ekspor' }}">
   <!-- Schema Item -->
    {{-- Schema Item --}}
