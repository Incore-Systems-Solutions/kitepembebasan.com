...
<div class="post-area">
    <div *ngFor="let story of stories" class="post-card">
        <div class="container">
                            ...
                            <div class="carousel-item active">
                                <div class="container">
                                    <div class="position-relative">
                                        ...
                                        >
                                            <h1 class="fw-bold text-white">{{ __('industri-ekspor.slide_1_title') }}</h1>
                                            <p class="mt-2">{{ __('industri-ekspor.slide_1_desc') }}</p>
                                            <a href="{{ url('kontak-kami') }}" class="btn btn-light mt-2">{{ __('industri-ekspor.slide_1_cta') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <h2 class="fw-bold text-center">{{ __('industri-ekspor.fitur') }}</h2>
            <div class="row row-cols-1 row-cols-md-3 g-4 mt-4">
                @for ($i = 1; $i <= 9; $i++)
                <div class="col">
                    <div class="card h-100 shadow border-0">
                        <div class="card-body">
                            <h5 class="card-title">{{ __('industri-ekspor.feature_'.$i.'_title') }}</h5>
                            <p class="card-text">{{ __('industri-ekspor.feature_'.$i.'_desc') }}</p>
                        </div>
                    </div>
                </div>
                @endfor
